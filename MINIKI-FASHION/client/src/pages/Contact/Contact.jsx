        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Sumangali Fancy Stores Opp.,
Municipality Street,
Usilampatti - 625532, Tamil Nadu, India</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm"> +91 93420 48363 | +91 80156 79288</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">minikifashion@gmail.com</p>
            </div>
          </div>
        </div>
